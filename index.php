...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color : #F0E68C ;">
              ...
              <div class="col-sm-12 col-md img text-center">
                <img src="ez/bank.png" class="img-fluid pt-2">
              </div>
            </div>
